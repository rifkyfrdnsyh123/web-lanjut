...
<body>
    ...
    ?>
        <tr>
            ...
            <td>
                <a class="btn btn-outline-primary btn-sm" href="editDosen.php?id=<?php echo encryptid($result->npp)?>">Edit</a>
                <a class="btn btn-outline-danger btn-sm" href="hpsDosen.php?id=<?php echo encryptid($result->npp)?>" onclick="return confirm ('Yakin dihapus?')">Delete</a></td>
        </tr>
    <?php
            $i++;
        }
