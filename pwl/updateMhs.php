		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td>
					...
					<a href="inputKRS.php?nim=<?php echo $row["nim"]?>" class="btn btn-warning btn-sm"> Input KRS</a>
					<a href="cetakpdf.php?type=krs&param=<?php echo $row["nim"]?>"class="btn btn-secondary btn-sm"> Cetak KRS</a>
