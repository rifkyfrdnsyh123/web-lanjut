...
MySQL - 10.4.28-MariaDB : Database - 06686
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`06686` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
(2,'0686.11.1990.000','lalang erawan','A12'),
...
insert  into `krs`(`idKrs`,`thAkd`,`nim`,`idMatkul`,`nilai`,`nppDos`,`hari`,`waktu`) values 
(1,NULL,'A12.2016.02898','A12.56101',NULL,'0686.11.1997.136','Senin','07.00'),
(2,NULL,'A12.2016.02898','A12.56102',NULL,'0686.11.1997.128','Senin','08.40'),
(3,NULL,'A12.2016.02900','A12.56101',NULL,'0686.11.1997.136','Senin','07.00'),
(4,NULL,'A12.2016.02898','A12.56105',NULL,'0686.11.1991.011','Jumat','12.30'),
(5,NULL,'A12.2016.02900','A12.56102',NULL,'0686.11.1997.128','Senin','08.40'),
(6,NULL,'A12.2016.02902','A12.56201',NULL,'0686.11.1998.152','Kamis','08.40'),
(7,NULL,'A12.2016.02902','A12.56202',NULL,'0686.11.1998.152','Senin','07.00'),
(8,NULL,'A12.2016.02900','A12.56103',NULL,'0686.11.1997.136','Selasa','10.20');
...
CREATE TABLE `kultawar` (
  `idmatkul` int(10) NOT NULL AUTO_INCREMENT,
  `npp` char(16) DEFAULT NULL,
  `klp` char(10) DEFAULT NULL,
...
insert  into `kultawar`(`idmatkul`,`npp`,`klp`,`hari`,`jamkul`,`ruang`) values 
(1,'0686.11.1997.136','A12.6201','Senin','07.00-08.40','H.5.5'),
(2,'0686.11.1997.128','A12.6101','Senin','08.40-10.20',NULL),
(3,'0686.11.1997.136','A12.6201','Selasa','10.20-12.00',NULL),
(4,'0686.11.1991.011','A12.6302','Kamis','14.10-16.20',NULL),
(5,'0686.11.1991.011','A12.6301','Jumat','12.30-14.10',NULL),
(6,'0686.11.1997.128','A12.6701','Rabu','08.40-10.20',NULL),
(7,'0686.11.1997.128','A12.6702','Jumat','10.20-12.00',NULL),
(8,'0686.11.1998.152','A12.6303','Kamis','08.40-10.20',NULL),
(9,'0686.11.1998.152','A12.6305','Senin','07.00-08.40',NULL),
(10,'0686.11.2000.241','A12.6204','Senin','07.00-08.40',NULL),
(11,'0686.11.1997.138','A12.6603','Jumat','14.10-16.20','H.5.2'),
(16,'0686.11.1992.026','A12.6803','Rabu','07.00-08.40','H.5.2');
