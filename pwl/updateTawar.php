...
<body>
    <div class="utama">
    <h2 class="text-center">DAFTAR PENAWARAN MATAKULIAH</h2>
    ...
    ?>
        <tr>
            ...
            <td>
                <a class="btn btn-outline-primary btn-sm" href="editKulTawar.php?id=<?php echo encryptid($result->idkultawar)?>">Edit</a>
                <a class="btn btn-outline-danger btn-sm" href="hpsKulTawar.php?id=<?php echo encryptid($result->idkultawar)?>" onclick="return confirm ('Yakin dihapus?')">Delete</a></td>
        </tr>
    <?php
            $i++;
        }
