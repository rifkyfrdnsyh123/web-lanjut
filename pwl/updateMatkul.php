...
<?php
    ...
    ?>
        <tr>
            ...
            <td>
                <a class="btn btn-outline-primary btn-sm" href="editMatkul.php?id=<?php echo encryptid($result->idmatkul)?>">Edit</a>
                <a class="btn btn-outline-danger btn-sm" href="hpsMatkul.php?id=<?php echo encryptid($result->idmatkul)?>" onclick="return confirm ('Yakin dihapus?')">Delete</a></td>
        </tr>
    <?php
            $i++;
        }
